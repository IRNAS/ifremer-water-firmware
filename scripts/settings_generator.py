...
data['gps_periodic_interval']   = 2
data['gps_triggered_interval']  = 0
data['gps_triggered_threshold'] = 15
data['gps_triggered_duration']  = 15
...
data['system_charge_max']       = 255
data['system_input_charge_min'] = 10000

data['pulse_threshold']         = 0
data['pulse_on_timeout']        = 0
data['pulse_min_interval']      = 0

data['gps_accel_z_threshold']   = 2000
